    ...
    <>
      <Grid container gap={0} sx={{ mt: 5, justifyContent: "center" }}>
        <Grid item md={6} sx={{ display: { xs: "none", md: "block" }, p: 0 }}>
          <img alt="lol" width="90%" height="90%" src="/assets/login.png" />
        </Grid>
        ...
        <Grid item md={4} sm={12} xs={12} sx={{ mt: 5 }}>
          ...
          >
            ...
            >
              ...
              >
                <img alt="lol" width="40%" src="/assets/signup.svg" />
              </Grid>
              <Grid
                container
                direction="column"
              ...
              >
                ...
                <Grid item md={12}>
                  <Typography variant="body2">
                    Already a member!{" "}
                    <Button onClick={() => historyHook("/login")} sx={{ p: 0 }}>
                      Log In
                    </Button>
                  </Typography>
                </Grid>
                ...
                <Grid item md={12} sx={{ mt: 3 }}>
                  <Typography variant="caption">
                    <CopyrightIcon fontSize="2px" /> 2022 SpameMeTwice. All
                    Rights Reserved.
                  </Typography>
                </Grid>
              </Grid>
